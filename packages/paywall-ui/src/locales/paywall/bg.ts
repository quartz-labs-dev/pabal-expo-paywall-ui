...
const bg = createPaywallLocaleText({
  ...
  text: {
    ...
    paywallSupportMessage: "Платеният абонамент много помага да продължаваме да създаваме и подобряваме това приложение. С абонамент ще получавате първи по-удобни функции, стабилна услуга и редовни актуализации.",
    profileSupportMessage: "Платеният абонамент много помага да продължаваме да създаваме и подобряваме това приложение. Ще се отблагодарим с по-стабилна услуга и редовни актуализации. Благодарим!",
    termsText: "Условия",

...
const bg = createPaywallLocaleText({
  ...
  text: {
    ...
    subscriptionRenewsAutomatically: "Плащанията се управляват сигурно от магазина. Автоматичните плащания могат да бъдат отменени в рамките на 7 дни. Ако автоматичното подновяване не бъде изключено поне 24 часа преди края на абонаментния период, акаунтът ви ще бъде таксуван автоматично.",
    ...
    pricePerWeeklyPeriodSuffix: " / седмица",
    renewsOnSuffix: "",
    saveSuffix: "",
    trialDayPlural: "дни",

...
const am = createPaywallLocaleText({
  ...
  text: {
    ...
    profileSupportMessage: "የተከፈለ ምዝገባ ይህን መተግበሪያ ቀጥሎ ለመገንባት እና ለማሻሻል ትልቅ ድጋፍ ነው። ድጋፍዎን በተረጋጋ አገልግሎት እና በቀጣይ ዝማኔዎች እመልሳለሁ። እናመሰግናለን!",
    termsText: "ውሎች",
    closeButtonAccessibilityLabel: "የክፍያ ገጹን ዝጋ",
    monthlyPriceSuffix: "",
    pricePerAnnualPeriodSuffix: " / ዓመት",
    pricePerMonthlyPeriodSuffix: " / ወር",
    pricePerWeeklyPeriodSuffix: " / ሳምንት",
    renewsOnSuffix: "",
    saveSuffix: "",
    trialDayPlural: "ቀናት",
    trialDaySingular: "ቀን",

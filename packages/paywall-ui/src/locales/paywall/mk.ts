...
const mk = createPaywallLocaleText({
  ...
  text: {
    ...
    restoring: "Се враќа...",
    subscriptionRenewsAutomatically: "Плаќањата безбедно ги управува продавницата. Автоматските плаќања може да се откажат во рок од 7 дена. Ако автоматското обновување не се исклучи најмалку 24 часа пред крајот на периодот на претплата, вашата сметка ќе биде автоматски наплатена.",
    ...
    pricePerWeeklyPeriodSuffix: " / недела",
    renewsOnSuffix: "",
    saveSuffix: "",
    trialDayPlural: "дена",

...
const el = createPaywallLocaleText({
  ...
  text: {
    ...
    paywallSupportMessage: "Η πληρωμένη συνδρομή βοηθά πολύ στο να συνεχίσουμε να δημιουργούμε και να βελτιώνουμε αυτήν την εφαρμογή. Με τη συνδρομή θα λαμβάνετε πρώτοι πιο βολικές λειτουργίες, σταθερή υπηρεσία και συνεχείς ενημερώσεις.",
    profileSupportMessage: "Η πληρωμένη συνδρομή βοηθά πολύ στο να συνεχίσουμε να δημιουργούμε και να βελτιώνουμε αυτήν την εφαρμογή. Θα το ανταποδώσουμε με πιο σταθερή υπηρεσία και συνεχείς ενημερώσεις. Ευχαριστούμε!",
    termsText: "Όροι",

...
const uk = createPaywallLocaleText({
  ...
  text: {
    ...
    subscriptionRenewsAutomatically: "Платежі безпечно обробляються магазином. Автоматичні платежі можна скасувати протягом 7 днів. Якщо автоматичне поновлення не вимкнути щонайменше за 24 години до завершення періоду підписки, з вашого облікового запису буде автоматично списано кошти.",
    subscribedSubtitle: "Дякуємо за підтримку!",
    supportMessageLabel: "Від розробника",
    paywallSupportMessage: "Платна підписка дуже допомагає підтримувати цей застосунок і робити його кращим. Підписники першими отримують зручніші функції, стабільніший сервіс і регулярні оновлення.",
    profileSupportMessage: "Платна підписка дуже допомагає підтримувати цей застосунок і робити його кращим. Ми віддячимо стабільнішим сервісом і регулярними оновленнями. Дякуємо!",
    termsText: "Умови",
    closeButtonAccessibilityLabel: "Закрити paywall",
    monthlyPriceSuffix: "",
    pricePerAnnualPeriodSuffix: " / рік",
    pricePerMonthlyPeriodSuffix: " / місяць",
    pricePerWeeklyPeriodSuffix: " / тиждень",
    renewsOnSuffix: "",
    saveSuffix: "",
    trialDayPlural: "дні",
